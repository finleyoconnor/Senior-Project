...
veg.vars.v <- island_veg_all %>%
  ...
  dplyr::select(location, month, gps, Z, spp, genus, type, sp_richness, cover, height, herg_count, gbbg_count, coei_count) #can decide later if you need X and Y or classed height/cover, etc
