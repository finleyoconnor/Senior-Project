...
island_veg <- read_csv(paste0(base_dir,"data/island_veg.csv"))
#veg_attributes <- read_csv(paste0(base_dir, "data/plotpointsattributes.csv")) 
#gdi_attributes <- read_csv(paste0(base_dir, "data/gdipointsattributes.csv"))
smpl_attributes <- read_csv(paste0(base_dir, "data/sampled.csv"))
```
...
gdi_bird <- st_read(paste0(base_dir,"/data/gull data/gdi_nests/gdi_nests_Merge.shp"))
heron_bird <- st_read(paste0(base_dir,"/data/gull data/heron_nests/herg_nests_heron.shp"))
schoodic_bird <- st_read(paste0(base_dir,"/data/gull data/schoodic_nests/all_nests.shp"))
shabby_bird <- st_read(paste0(base_dir,"/data/gull data/shabby_nests/gull_eider_nests.shp"))
```
...
#check misaligned obs in smpl_attributes & island_veg
```{r}
#rCompare(smpl_attributes,island_veg, key = 'name'~'gps')
```
...
<!--                   left_join(smpl_attributes, join_by("gps" == "name")) -->
<!-- ``` -->
<!-- - -->
