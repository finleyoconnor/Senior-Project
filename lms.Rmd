...
r2_hergC <- partR2(lm.hergC, partvars = c("Z", "cover", "sp_richness"), R2_type = "marginal", nboot = 10)
r2_hergH <- partR2(lm.hergH, partvars = c("Z", "height", "sp_richness"), R2_type = "marginal", nboot = 10)
```
```{r herg r2 summary}
summary(r2_herg.mar)
summary(r2_herg.con)
