...
```{r aictab}
#herring gull
modelhergs <- list(lm.hergC, lm.hergH)
modelhergs.names <- c("lm.hergC", "lm.hergH")
names(modelhergs) <- c("lm.hergC", "lm.hergH")
modelhergs
aictab(modelhergs)

#great black-backed gull
modelgbbg <- list(lm.gbbgC, lm.gbbgH)
modelgbbg.names <- c("lm.gbbgC", "lm.gbbgH")
names(modelhergs) <- c("lm.gbbgC", "lm.gbbgH")
modelgbbg
aictab(modelgbbg)
```
